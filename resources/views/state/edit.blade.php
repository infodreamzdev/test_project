@extends('layouts.app', ['activePage' => 'state', 'titlePage' => __('Edit State')])
...
@section('content')
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <form method="post" id="stateFrm" action="{{ route('state.update',$details->id) }}" autocomplete="off" class="form-horizontal">
            @csrf   
            @method('put')       
